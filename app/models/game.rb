      ...
      parameters: {
        ...
        messages: [{
          role: "user", content: "Give me an infomative yet brief #{description} for the
           game's #{name} and #{category}.Give me only the text of description alonside with the name and category , without any of your own answer like 'Here is a simple description'. Don t put any stars AT all. At the end, add A Famous motivating quote"
        }]
      })
